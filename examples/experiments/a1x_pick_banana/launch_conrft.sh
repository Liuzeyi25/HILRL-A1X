...
#   PRETRAIN_STEPS=96000  — 预训练步数 (默认 96000)
#
...
#   切换 pane:    Ctrl-b ← / →
#   detach:       Ctrl-b d
#   kill session: tmux kill-session -t cr_a1x_pick_banana
...
PRETRAIN_STEPS=${PRETRAIN_STEPS:-96000}
DEBUG=${DEBUG:-False}
...
# ---- 路径配置 ----
SESSION="cr_a1x_pick_banana"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
CKPT_PATH="/home/dungeon_master/conrft/examples/experiments/a1x_pick_banana/conrft/${RUN_TAG}"
DEMO_PATH="/home/dungeon_master/conrft/examples/experiments/a1x_pick_banana/demo_data/20260225/traj_20_0225.pkl"

# ---- 首次打印所有配置 ----
echo ""
echo "╔════════════════════════════════════════════════════════════╗"
echo "║              ConRFT Launch — a1x_pick_banana               ║"
echo "╠════════════════════════════════════════════════════════════╣"
