#!/usr/bin/env bash
# 统一启动脚本：在同一个 tmux session 中同时启动 learner (左侧) 和 actor (右侧)，左右分屏显示
...
#   RUN_TAG=none__cov_K8__0302_134736 bash launch_hilserl.sh   # 续训已有 checkpoint
#
# tmux 操作:
#   切换 pane:    Ctrl-b ← / →
#   detach:       Ctrl-b d
#   kill session: tmux kill-session -t hl_a1x_pick_banana
...
# ---- tmux 配置 ----
SESSION="hl_a1x_pick_banana"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
CKPT_PATH="/home/dungeon_master/conrft/examples/experiments/a1x_pick_banana/hilserl/${RUN_TAG}"
DEMO_PATH="/home/dungeon_master/conrft/examples/experiments/a1x_pick_banana/demo_data/20260301/traj_10.pkl"

echo "========================================"
echo " Task:    a1x_pick_banana"
