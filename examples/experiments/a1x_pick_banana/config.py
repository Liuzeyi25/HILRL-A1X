...
# - -0.09851063829787234
    ...
    RESET_JOINT_STATE = np.array([-0.08659574468085106, 1.8085106382978722, -1.526595744680851, 1.1657446808510638, -0.147446808510638296, -0.09851063829787234, 100.0])  # 夹爪张开
