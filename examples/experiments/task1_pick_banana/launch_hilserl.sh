...
#   detach:       Ctrl-b d
#   kill session: tmux kill-session -t hl_task1_pick_banana
...
# ---- tmux 配置 ----
SESSION="hl_task1_pick_banana"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
CKPT_PATH="/home/dungeon_master/conrft/examples/experiments/task1_pick_banana/hilserl/${RUN_TAG}"
DEMO_PATH="${SCRIPT_DIR}/demo_data/traj.pkl"

echo "========================================"
echo " Task:    task1_pick_banana"
