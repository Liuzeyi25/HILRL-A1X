...
#   detach:       Ctrl-b d
#   kill session: tmux kill-session -t hl_toast_bread
...
# ---- tmux 配置 ----
SESSION="hl_toast_bread"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
CKPT_PATH="/home/dungeon_master/conrft/examples/experiments/toast_bread/hilserl/${RUN_TAG}"
DEMO_PATH="/home/dungeon_master/conrft/examples/experiments/toast_bread/demo_data/20260229/traj_20.pkl"

echo "========================================"
echo " Task:    toast_bread"
