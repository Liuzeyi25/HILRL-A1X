...
# - 0.043617021276595745
    ...
    RESET_JOINT_STATE = np.array([-0.08659574468085106, 1.685106382978722, -1.406595744680851, 0.9657446808510638, -0.147446808510638296, -0.01851063829787234, 100.0])  # 中立位置 (7维)
