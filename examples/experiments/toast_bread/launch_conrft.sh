...
#   切换 pane:    Ctrl-b ← / →
#   detach:       Ctrl-b d
#   kill session: tmux kill-session -t cr_toast_bread
...
# ---- 路径配置 ----
SESSION="cr_toast_bread"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
CKPT_PATH="/home/dungeon_master/conrft/examples/experiments/toast_bread/conrft/${RUN_TAG}"
DEMO_PATH="${SCRIPT_DIR}/demo_data/20260222/traj_20.pkl"

# ---- 首次打印所有配置 ----
echo ""
echo "╔════════════════════════════════════════════════════════════╗"
echo "║              ConRFT Launch — toast_bread                   ║"
echo "╠════════════════════════════════════════════════════════════╣"
