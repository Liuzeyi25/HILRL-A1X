...
#   切换 pane:    Ctrl-b ← / →
#   detach:       Ctrl-b d
#   kill session: tmux kill-session -t cr_insert_block
...
# ---- 路径配置 ----
SESSION="cr_insert_block"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
CKPT_PATH="/home/dungeon_master/conrft/examples/experiments/insert_block/conrft/${RUN_TAG}"
DEMO_PATH="${SCRIPT_DIR}/demo_data/20260228/traj_10.pkl"

# ---- 首次打印所有配置 ----
echo ""
echo "╔════════════════════════════════════════════════════════════╗"
echo "║              ConRFT Launch — insert_block                  ║"
echo "╠════════════════════════════════════════════════════════════╣"
