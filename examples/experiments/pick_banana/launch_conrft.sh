...
#   PRETRAIN_STEPS=96000  — 预训练步数 (默认 20000)
#
...
#   切换 pane:    Ctrl-b ← / →
#   detach:       Ctrl-b d
#   kill session: tmux kill-session -t cr_task1_pick_banana
...
# ---- 路径配置 ----
SESSION="cr_task1_pick_banana"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
CKPT_PATH="/home/dungeon_master/conrft/examples/experiments/task1_pick_banana/conrft/${RUN_TAG}"
DEMO_PATH="${SCRIPT_DIR}/demo_data/task1_pick_banana_30_demos.pkl"

# ---- 首次打印所有配置 ----
echo ""
echo "╔════════════════════════════════════════════════════════════╗"
echo "║              ConRFT Launch — task1_pick_banana             ║"
echo "╠════════════════════════════════════════════════════════════╣"
