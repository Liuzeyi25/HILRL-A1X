...
#   detach:       Ctrl-b d
#   kill session: tmux kill-session -t hl_insert_network_cable
...
# ---- tmux 配置 ----
SESSION="hl_insert_network_cable"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
CKPT_PATH="/home/dungeon_master/conrft/examples/experiments/insert_network_cable/hilserl/${RUN_TAG}"
DEMO_PATH="${SCRIPT_DIR}/demo_data/traj.pkl"

echo "========================================"
echo " Task:    insert_network_cable"
