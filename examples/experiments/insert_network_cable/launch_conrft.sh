...
#   PRETRAIN_STEPS=96000  — 预训练步数 (默认 100000)
#
...
#   切换 pane:    Ctrl-b ← / →
#   detach:       Ctrl-b d
#   kill session: tmux kill-session -t cr_insert_network_cable
...
# ---- 路径配置 ----
SESSION="cr_insert_network_cable"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
CKPT_PATH="/home/dungeon_master/conrft/examples/experiments/insert_network_cable/conrft/${RUN_TAG}"
DEMO_PATH="/home/dungeon_master/conrft/examples/experiments/insert_network_cable/demo_data/20260222/traj_20.pkl"

# ---- 首次打印所有配置 ----
echo ""
echo "╔════════════════════════════════════════════════════════════╗"
echo "║              ConRFT Launch — insert_network_cable          ║"
echo "╠════════════════════════════════════════════════════════════╣"
