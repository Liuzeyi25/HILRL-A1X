...
#   detach:       Ctrl-b d
#   kill session: tmux kill-session -t hl_fold_towel
...
# ---- tmux 配置 ----
SESSION="hl_fold_towel"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
CKPT_PATH="/home/dungeon_master/conrft/examples/experiments/fold_towel/hilserl/${RUN_TAG}"
DEMO_PATH="${SCRIPT_DIR}/demo_data/20260229/traj_20.pkl"

echo "========================================"
echo " Task:    fold_towel"
