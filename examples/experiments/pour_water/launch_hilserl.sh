...
#   detach:       Ctrl-b d
#   kill session: tmux kill-session -t hl_pour_water
...
# ---- tmux 配置 ----
SESSION="hl_pour_water"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
CKPT_PATH="/home/dungeon_master/conrft/examples/experiments/pour_water/hilserl/${RUN_TAG}"
