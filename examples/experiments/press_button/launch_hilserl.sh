...
#   detach:       Ctrl-b d
#   kill session: tmux kill-session -t hl_press_button
...
# ---- tmux 配置 ----
SESSION="hl_press_button"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
CKPT_PATH="/home/dungeon_master/conrft/examples/experiments/press_button/hilserl/${RUN_TAG}"
DEMO_PATH="${SCRIPT_DIR}/demo_data/20260229/traj_20.pkl"

echo "========================================"
echo " Task:    press_button"
