...
#   PRETRAIN_STEPS=96000  — 预训练步数 (默认 40000)
#
...
#   切换 pane:    Ctrl-b ← / →
#   detach:       Ctrl-b d
#   kill session: tmux kill-session -t cr_take_out_bread
...
# ---- 路径配置 ----
SESSION="cr_take_out_bread"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
CKPT_PATH="/home/dungeon_master/conrft/examples/experiments/take_out_bread/conrft/${RUN_TAG}"
DEMO_PATH="${SCRIPT_DIR}/demo_data/traj.pkl"

# ---- 首次打印所有配置 ----
echo ""
echo "╔════════════════════════════════════════════════════════════╗"
echo "║              ConRFT Launch — take_out_bread                ║"
echo "╠════════════════════════════════════════════════════════════╣"
