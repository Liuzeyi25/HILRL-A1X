...
#   detach:       Ctrl-b d
#   kill session: tmux kill-session -t hl_take_out_bread
...
# ---- tmux 配置 ----
SESSION="hl_take_out_bread"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
CKPT_PATH="/home/dungeon_master/conrft/examples/experiments/take_out_bread/hilserl/${RUN_TAG}"
DEMO_PATH="${SCRIPT_DIR}/demo_data/traj.pkl"

echo "========================================"
echo " Task:    take_out_bread"
