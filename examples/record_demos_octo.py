...
from examples.data_util import add_mc_returns_to_trajectory, add_embeddings_to_trajectory, add_next_embeddings_to_trajectory
...
def main(_):
    ...
    while success_count < success_needed:
        ...
        if done:
            if info["succeed"]:
                print(f"\n✅ 成功! 第 {success_count + 1}/{success_needed} 条轨迹完成")
